...
const IndexPage = () => (
  <div id="box" style={{ position: 'relative' }}>
    ...
    <div
      id="mc_embed_signup"
      style={{ clear: 'left', width: '100%', fontFamily: 'sans-serif' }}
    >
      <form
        action="https://cascadiajs.us1.list-manage.com/subscribe/post?u=ffa37cf28eebc9e75b8558f3b&amp;id=d1b100650c"
        method="post"
      ...
      >
        <div id="mc_embed_signup_scroll">
          ...
          >
            <input
              type="text"
              name="b_ffa37cf28eebc9e75b8558f3b_d1b100650c"
              tabIndex="-1"
              value=""
            />
          </div>
